...
void Calendrier::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Calendrier::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Calendrier::swapS)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Calendrier::staticMetaObject = {
    { &QCalendarWidget::staticMetaObject, qt_meta_stringdata_Calendrier.data,
      qt_meta_data_Calendrier,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Calendrier::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Calendrier.stringdata0))
        return static_cast<void*>(const_cast< Calendrier*>(this));
