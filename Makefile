...
COMPRESS      = gzip -9f
DISTNAME      = plane1.0.0
DISTDIR = /auto_home/rcolindeverd/moteur/hmin317-tp3/.tmp/plane1.0.0
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
...
moc_mainwidget.cpp: geometryengine.h \
		mainwidget.h
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64 -I/auto_home/rcolindeverd/moteur/hmin317-tp3 -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I/usr/include/c++/5 -I/usr/include/x86_64-linux-gnu/c++/5 -I/usr/include/c++/5/backward -I/usr/lib/gcc/x86_64-linux-gnu/5/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/5/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include mainwidget.h -o moc_mainwidget.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/auto_home/rcolindeverd/moteur/hmin317-tp3/. || mkdir -p $(INSTALL_ROOT)/auto_home/rcolindeverd/moteur/hmin317-tp3/.
	-$(INSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/auto_home/rcolindeverd/moteur/hmin317-tp3/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/auto_home/rcolindeverd/moteur/hmin317-tp3/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/auto_home/rcolindeverd/moteur/hmin317-tp3/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/auto_home/rcolindeverd/moteur/hmin317-tp3/./ 
